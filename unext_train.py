...
def parse_args():
    ...
    parser.add_argument('--name', default='retest',
    ...
    parser.add_argument('--input_w', default=800, type=int,
                        help='image width')
...
def main():
    ...
    # Data loading code
    train_img_ids = glob(os.path.join('/home/xnqlzh/jysuh/images/resized/train/images', '*' + config['img_ext']))
    train_img_ids = [os.path.splitext(os.path.basename(p))[0] for p in train_img_ids]

    val_img_ids = glob(os.path.join('/home/xnqlzh/jysuh/images/resized/val/images', '*' + config['img_ext']))
    ...
    train_dataset = Dataset(
        ...
        img_dir='/home/xnqlzh/jysuh/images/resized/train/images/',
        mask_dir='/home/xnqlzh/jysuh/images/resized/train/masks/',
    ...
    val_dataset = Dataset(
        img_ids=val_img_ids,
        img_dir='/home/xnqlzh/jysuh/images/resized/val/images/',
        mask_dir='/home/xnqlzh/jysuh/images/resized/val/masks/',
        img_ext=config['img_ext'],
        mask_ext=config['mask_ext'],
        num_classes=config['num_classes'],
